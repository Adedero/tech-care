...
import { SwitchCase, SwitchCaseItem } from './switchcase';
...
export default function Icon ({ icon, width, height, fill = "#072635" } : IconProps) {
  return (
    <SwitchCase case={icon}>
      <SwitchCaseItem value="logo">
        <svg id="TestLogo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={width ?? "210.582"} height={height ?? "48"} viewBox="0 0 210.582 48">
          <defs>
          ...
          <g id="Text" transform="translate(62.607 15.27)" style={{ mixBlendMode: "normal", isolation: "isolate" }}>
            <path id="Path_3-2" data-name="Path 3" d="M147.873,31.94V37.5h-5.564V54.446h-5.756V37.5H130.99V31.94h16.878Z"
      ...
      <SwitchCaseItem value="arrow-down">
        <svg xmlns="http://www.w3.org/2000/svg" width={width ?? "9.999"} height={height ?? "5.479"} viewBox="0 0 9.999 5.479">
          <path id="ArrowDown" d="M333.518-544.8l-4.177-4.178a.673.673,0,0,1-.136-.193.532.532,0,0,1-.05-.228.606.606,0,0,1,.165-.424.56.56,0,0,1,.434-.18h8.8a.56.56,0,0,1,.434.181.611.611,0,0,1,.165.423,1.85,1.85,0,0,1-.186.421l-4.177,4.177a.962.962,0,0,1-.3.21.851.851,0,0,1-.338.066.851.851,0,0,1-.339-.066A.963.963,0,0,1,333.518-544.8Z" transform="translate(-329.155 549.999)" fill={fill}/>
        </svg>

      </SwitchCaseItem>

      <SwitchCaseItem value="download">
      ...
      <SwitchCaseItem value="temperature">
        <svg id="temperature" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
        width={width ?? "96"} height={height ?? "96"} viewBox="0 0 96 96">
          <defs>
            <clipPath id="clip-path">
      ...
      <SwitchCaseItem value="heart-bpm">
        <svg id="HeartBPM" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
        width={width ?? "96"} height={height ?? "96"} viewBox="0 0 96 96">
          <defs>
            <clipPath id="clip-path">
